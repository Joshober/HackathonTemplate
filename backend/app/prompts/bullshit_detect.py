...
2. "analysis": The full written analysis for reading on screen only (not read aloud). Use a serious, helpful, and constructive tone. Clearly identify specific issues (jargon, unsupported claims, gaps) and explain why they matter. Offer brief, practical guidance where relevant (e.g. what to ask for instead, what to watch for). Do not rewrite the document in plain language—focus on your analytical commentary. Be concise but thorough; under 1500 characters.
